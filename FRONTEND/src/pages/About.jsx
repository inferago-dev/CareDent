...
const VALUES = [
  ...
  {
    icon: Wrench,
    title: 'All Over Tamil Nadu',
    description: 'From Chennai to any district in Tamil Nadu, our installation and breakdown support travels with your clinic.'
  },
  {
    icon: Award,
        ...
        <div className="relative container-page max-w-4xl text-center">
          ...
          <Reveal delay={100}>
            <p className="text-slate-400 text-base leading-relaxed max-w-2xl mx-auto mt-6">
              ...
              the Care Dent team have installed and maintained dental chairs for clinics and hospitals all over Tamil Nadu.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="container-page max-w-7xl">
          <Reveal>
            <div className="max-w-xl mb-14">
              <span className="block text-xs uppercase tracking-widest text-slate-500 font-medium mb-2">
            ...
            {VALUES.map((value, idx) => (
              <Reveal key={value.title} delay={idx * 100} y={24}>
                <div className="h-full bg-white border border-slate-200 rounded-2xl p-7 space-y-4 hover:border-cyan-200 hover:shadow-lg hover:shadow-cyan-900/5 transition-all duration-500">
                  ...
                  <h3 className="text-base font-medium text-slate-900 tracking-tight">{value.title}</h3>
                  <p className="text-sm text-slate-500 leading-relaxed tracking-tight">{value.description}</p>
                </div>
              </Reveal>
            ))}
          </div>
