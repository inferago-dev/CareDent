...
/* Inline hero entrance animations — triggered once on mount, not on scroll */
const heroEnter = {
  label:   { animation: 'fade-in 600ms cubic-bezier(0.22, 1, 0.36, 1) 100ms both' },
  h1:      { animation: 'hero-rise 900ms cubic-bezier(0.22, 1, 0.36, 1) 180ms both' },
  tagline: { animation: 'fade-in 700ms cubic-bezier(0.22, 1, 0.36, 1) 320ms both' },
      ...
      <div ref={parallaxRef} className="relative container-page max-w-7xl will-change-transform w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <span style={heroEnter.label} className="block text-xs uppercase tracking-widest text-slate-400">
              Dental Equipment &amp; Clinical Solutions
            </span>

            <h1 style={heroEnter.h1} className="text-4xl sm:text-5xl lg:text-6xl tracking-tighter font-medium">
              <span className="text-cyan-500 font-playfair italic">Dental chairs</span> that come with the engineers who service them.
            </h1>

            <p style={heroEnter.tagline} className="text-slate-400 text-base leading-relaxed tracking-tight max-w-xl">
            ...
            {/* CTAs */}
            <div style={heroEnter.ctas} className="flex flex-wrap items-center gap-4 pt-2">
              <Link
                to="/products"
          ...
          <div className="lg:col-span-5 relative flex flex-col items-center justify-center mt-10 lg:mt-0 lg:min-h-[600px]">
            <div className="relative w-full max-w-[320px] sm:max-w-[400px] lg:max-w-[500px] aspect-square flex items-center justify-center">
              ...
              {HERO_FACTS.map(({ icon: Icon, title, detail, position }, i) => (
                <div
                  key={title}
