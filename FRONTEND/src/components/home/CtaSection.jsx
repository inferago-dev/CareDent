  ...
  return (
    <section className="relative pt-10 section-pb bg-white overflow-hidden">
      <div className="container-page max-w-7xl">
        <Reveal variant="scale" scale={0.97} duration={1000}>
          <div className="relative rounded-3xl bg-blue-950 text-white overflow-hidden">
            ...
            <div ref={parallaxRef} className="relative max-w-3xl mx-auto px-6 py-8 sm:py-12 text-center space-y-6 will-change-transform">
              ...
              <Reveal delay={180}>
                <p className="text-slate-400 text-base max-w-xl mx-auto tracking-tight">
              ...
              <Reveal delay={280} y={16}>
                <div className="pt-2">
                  <button
                    ...
                    className="inline-flex items-center gap-2 tracking-tight rounded-full bg-white text-blue-950 text-md px-3 ps-5 py-2.5 hover:bg-cyan-50 transition-colors cursor-pointer"
                  >
